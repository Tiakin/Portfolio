...
export class ScreenContentManager {
	constructor() {
		...
		this.browserTabs = [
			{
				...
				description:
					'Application web collaborative simulant un bureau connecté avec calendrier et widgets.',
				...
				skills: [
					{
						...
						description:
							"Création d'une application web avec composants dynamiques comme le calendrier et les widgets."
					},
					{
					...
					},
					{
						...
						description:
							"Mise en ligne de l'application avec configuration d'un serveur et gestion des dépendances."
					},
					{
						name: 'Collaborer : Situer son rôle et ses missions au sein d’une équipe informatique',
						description:
							'Travail en équipe de 4 avec répartition des tâches, intégration continue et gestion de version.'
					}
				]
			},
			{
			...
			},
			{
				...
				description:
					'Application de gestion de listes de courses développée en Symfony, avec fonctions collaboratives.',
				...
				skills: [
					{
						...
						description:
							"Création d'une application fonctionnelle avec back-end, front-end et persistance."
					},
					{
					...
					},
					{
						name: 'Collaborer : Situer son rôle et ses missions au sein d’une équipe informatique',
						description:
							'Développement en groupe avec Git et communication régulière sur les tâches.'
					}
				]
			},
			{
				...
				description:
					'Site de sensibilisation aux moyens de transport écologiques disponibles sur le campus de la Doua.',
				...
				skills: [
					...
					},
					{
						name: 'Conduire : Identifier les besoins métiers des clients et des utilisateurs',
						description:
							"Adapter le message pour informer et sensibiliser les étudiants à l'écologie."
					},
					{
						name: 'Collaborer : Situer son rôle et ses missions au sein d’une équipe informatique',
					...
					},
					{
						...
						description:
							'Système simple de données, potentiellement en JSON ou statique, pour les infos transport.'
					}
				]
			}
		];
		...
		this.taskbarApps = [
			{
				...
				title: 'SAE Avion',
				description:
					"SAE consistant à visualiser les trajectoires de vols et détecter les collisions aériennes grâce à la coloration d'un graphe.",
			...
			},
			{
				...
				title: 'Survie',
				description:
					'Plugin Minecraft complet développé seul ajoutant blocs, systèmes de craft et mécaniques de survie.',
				...
				skills: [
					{
						...
						description:
							'Développement dans un environnement contraint avec contraintes temps réel.'
					},
					{
						name: 'Optimiser : Analyser et optimiser des applications',
						description:
							'Optimisation des comportements, compatibilité serveur, gestion des ressources.'
					},
					{
						name: 'Administrer : Déployer des services dans une architecture réseau',
			...
			},
			{
				...
				title: 'MT Vehicles',
				description:
					'Plugin Minecraft de gestion de véhicules, je suis contributeur actif sur ce projet open source.',
				technologies: ['Java', 'Spigot API', 'YAML', 'Git', 'Gradle'],
				skills: [
					{
						name: 'Réaliser : Partir des exigences et aller jusqu’à une application complète',
						description:
							'Ajout de modules fonctionnels dans un code existant, participation active au projet.'
					},
					{
						name: 'Optimiser : Sélectionner les algorithmes adéquats pour répondre à un problème donné',
						description:
							'Améliorations de performances, gestion fine des comportements des véhicules.'
					},
					{
					...
					},
					{
						name: 'Collaborer : Situer son rôle et ses missions au sein d’une équipe informatique',
						description:
							"Contribution open source, communication avec d'autres développeurs du projet."
					}
				]
			}
		];
		...
		this.mobileApp = {
			...
			name: 'LyonGuessr',
			description:
				'Jeu mobile inspiré de GeoGuessr basé sur la ville de Lyon, avec géolocalisation, scoring et photos.',
			technologies: ['Kotlin', 'Google Maps API', 'Firebase', 'Android'],
			skills: [
				{
					name: 'Réaliser : Adapter des applications sur un ensemble de supports (embarqué, web, mobile, IoT…)',
					description:
						"Application mobile multiplateforme avec carte, timer et gestion de l'état de jeu."
				},
				{
					name: 'Optimiser : Sélectionner les algorithmes adéquats pour répondre à un problème donné',
	...
	drawBrowserLeftScreen(ctx, canvas) {
		...
		// Afficher l'image du contenu
		const loadedImage = this.loadedImages.get(activeTab.imageUrl);
		if (loadedImage) {
	...
	drawWindowsRightScreen(ctx, canvas) {
		...
		ctx.save();
		ctx.scale(1, 1);
		const taskbarHeight = 40; // Barre horizontale en bas
